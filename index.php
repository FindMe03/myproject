...
<head>
    ...
    <title>Jhunie Web Page_1.0</title>

    <link rel="stylesheet" href="assets/css/bootstrap.css">
    <script src="assets/bootstrap.js" integrity="sha384-MrcW6ZMFYlzcLA8Nl+NtUVF0sA7MsXsP1UyJoMp4YLEuNSfAP+JcXn/tWtIaxVXM" crossorigin="anonymous"></script>
...
<main class="container">
  <div class="p-4 p-md-5 mb-4 text-white rounded bg-dark">
    <div class="col-md-6 px-0">
      <h1 class="display-4 fst-italic">This is my first project</h1>
      <p class="lead my-3">Please support my blogs.i hope this project will succeed.</p>
      <p class="lead mb-0"><a href="https://www.youtube.com/channel/UCf9IpZbyxGhcOn5bfjENw9A" class="text-white fw-bold">My Youtube channel</a></p>
    </div>
  </div>
  ...
  <div class="row g-5">
    <div class="col-md-8">
      ...
      <article class="blog-post">
        <h2 class="blog-post-title">Racing Pigeon</h2>
        

        <p>Pigeon racing is the sport of releasing specially trained homing pigeons, which then return to their homes over a carefully measured distance. The time it takes the animal to cover the specified distance is measured and the bird's rate of travel is calculated and compared with all of the other pigeons in the race to determine which animal returned at the highest speed.
...
In the United States, there are hundreds of local, state and national pigeon clubs that sponsor shows. The largest shows are the National Young Bird Show, held in Louisville, Kentucky in October, and the National Pigeon Association's Grand National, held in a different city each year and usually in January.</p>
        
        <h2>Example lists</h2>
      
        <p><h4>Racing Pigeon</h4></p>
        <ul>
          <li><a href="https://www.pigeons.biz/threads/jozef-van-den-broucke.49523/">Jozef Van den Broucke</a></li>
          <li><a href="https://www.heitzmansions.com/">Heitzman Sions</a></li>
          <li><a href="https://pigeonracingph.wordpress.com/bazra/">Bazra Line</a></li>
        </ul>
        <p><h4>Fancy Pigeon</h4></p>
        <ul>
          <li><a href="https://en.wikipedia.org/wiki/Fantail_pigeon">Fantail Pigeon</a></li>
          <li><a href="https://en.wikipedia.org/wiki/Old_Dutch_Capuchine">Old Dutch Capuchine</a></li>
          <li><a href="https://en.wikipedia.org/wiki/English_Trumpeter">English Trumpeter</a></li>
        </ul>
      
        <dl>
          <hr>
          <dt><i>History</i></dt>
          <dd>Pigeons are the oldest domesticated bird.[citation needed] The predecessors of modern-day racing pigeons were pigeons bred for their homing ability, primarily to carry messages. "Pigeon posts" have been established all over the world and while mainly used in the military, some are still in service today. Modern pigeon racing originated in Belgium in the mid 19th century.[3] Racing pigeons were first developed in Belgium and England at the same time.[5] They are the result of crossing of a number of other breeds, primarily the Smerle, French Cumulet, English Carrier, Dragoon, and the Horseman (now lost). From the high-flying Cumulet, the Homer received its endurance and its ability to fly for hours on end without tiring. From the Carrier, it inherited the ability to find its way home from great distances.[5]
...
With the advent of electronic timing system recording birds’ arrival has never been easier. The ETS technology is developing year on year and it is taking over the pigeon world, changing it and making it fit for today's conditions. As a result of this new way of registering a bird's arrival, several loft management software have been created in the last 10 years to help fanciers with record keeping, pigeon pedigree, publishing race results or keep track of treatment and vaccination records.</dd>
        </dl>
      
        <h2>One-Loft Racing</h2>
        <hr>
        <p>The latest development and preferred method for timing racing pigeons is the Electronic Timing System. The bird's arrival is recorded automatically. When using an electronic system, the pigeon fancier does not even have to be at the loft to clock the birds as they return.[11] Birds are fitted with a band that has a tiny RFID chip in it which can be read when the bird comes home. At the home loft the electronic scanning records the pigeons' arrival. The pad or antenna is placed at the entry point to the loft entrance and as the pigeon crosses it the electronic band is scanned. The clock is attached to the antennas. The serial number of the transponder ring is recorded along with the time of arrival. This is very similar to transponder timing systems used in human races.[12]

In February 2008 the members of the Penygraog Homing Society Racing Pigeon Club in Wales won an award to fund a new electronic timing device. The club was able to obtain the device thanks to funding from the All Wales award initiative. Club secretary John Williams said: "The electronic timer certainly makes it a lot easier for us".[13]

With the advent of electronic timing system recording birds’ arrival has never been easier. The ETS technology is developing year on year and it is taking over the pigeon world, changing it and making it fit for today's conditions. As a result of this new way of registering a bird's arrival, several loft management software have been created in the last 10 years to help fanciers with record keeping, pigeon pedigree, publishing race results or keep track of treatment and vaccination records.</p>
        
        <dt><h2>Training</h2></dt>
        <hr>
        
        <dd><p>Racing pigeons are housed together in a specially designed dovecote or loft. From about four weeks of age until the end of its racing career, the racing loft is the pigeon's home and is where it returns to on race day.
